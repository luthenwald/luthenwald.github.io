-- title       = Słyż: Categorical GPU Programming on Apple Silicon
-- pubDate     = 2026-05-23
-- tags        = *draft, category-theory, gpu, haskell, metal, slyz, 2026
...
--
-- > This essay is in early draft stage & heavily prototyped with llm.
--
